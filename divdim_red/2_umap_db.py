...
file1 = 'divdim_red/2024_bez.csv'
# Izejas fails, kas saturēs datus ar klasteriem
file2 = "divdim_red/2024_bez_db.csv"
...
# Standardizē datus (pārvērš kolonnas tā, lai tām būtu vidējā vērtība 0 un standartnovirze 1)
...
# Pievieno klasteru numurus datu kopā kā pirmo kolonnu
