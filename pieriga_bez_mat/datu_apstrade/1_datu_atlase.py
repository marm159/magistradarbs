...
file2 = 'pieriga_bez_mat/datu_apstrade/2024.csv'
...
rem_columns = [
    ...
    'Adreses pieraksts', 'Novads', 'Pagasts', 'Darījuma datums',
    ...
    'Būves lietošanas veida nosaukums', 'Būves lietošanas veida kods',
