...
df = df[
    ...
    (df['Pilsēta'].isin([
        "Brocēni", "Grobiņa", "Kandava", "Kuldīga", "Pāvilosta", "Saldus", "Talsi", "Tukums",
        "Balvi", "Līvāni", "Ludza", "Preiļi", "Ainaži", "Alūksne", "Cēsis", "Gulbene",
        "Limbaži", "Madona", "Salacgrīva", "Smiltene", "Aizkraukle", "Bauska", "Dobele", "Iecava"
    ]))  &  # Atrodas kādā pilsētā ar augstāku vērtību līmeni 
    (df['Pārdotā zemes kopplatība, m2'].isna())  # Bez pārdotās zemes
]
...
rem_columns = [
    ...
    'Pārdotā zemes kopplatība, m2', 'Zemes vienību kadastra apzīmējumi(saraksts) (viena darījuma ietvaros)',
...
# Izdzēš nevajadzīgās kolonnas
df = df.drop(columns=['Pilseta'])

# Aizvieto "nan" ar tukšu vērtību
df.replace("nan", np.nan, inplace=True)

# Izdzēš visas rindas, kurās ir vismaz viena tukša vērtība
df = df.dropna()
