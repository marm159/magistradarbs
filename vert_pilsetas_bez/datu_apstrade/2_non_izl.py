...
file1 = 'vert_pilsetas_bez/datu_apstrade/2024.csv'
# Izejas fails, kas saturēs datus bez izlēcējiem
file2 = 'vert_pilsetas_bez/datu_apstrade/2024_fin.csv'
# Izejas fails, kas saturēs izlēcējus
file3 = 'vert_pilsetas_bez/datu_apstrade/2024_izl.csv'
...
for region, pilsetas in regions.items():
    ...
    # Izņem no datiem tās rindas, kuru indeksi sakrīt ar izlēcēju datiem
