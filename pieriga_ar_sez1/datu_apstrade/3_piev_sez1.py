...
file1 = 'pieriga_ar_sez1/datu_apstrade/2023_fin.csv'
# Izvades fails, kas saturēs datus, ar pievienoto gadu un sezonu
file2 = 'pieriga_ar_sez1/2023_gg.csv'
...
# Veic one-hot encoding kolonnai 'Sezona', izveidojot atsevišķu kolonu katrai sezonai
