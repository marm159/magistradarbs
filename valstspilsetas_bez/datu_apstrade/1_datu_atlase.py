...
file1 = 'dati/TG_CSV_2022.csv'
# Izejas fails, kas saturēs tikai atlasītos darījumus
file2 = 'valstspilsetas_bez/datu_apstrade/2022.csv'
...
df = df[
    ...
    (df['Pilsēta'].isin([
         "Daugavpils", "Jēkabpils", "Jelgava", "Liepāja", "Ogre", "Rēzekne", 
        "Valmiera", "Ventspils"
    ]))  &  # Atrodas kādā no valstspilsētām
