...
file1 = 'valstspilsetas_bez/datu_apstrade/2024.csv'
# Izejas fails, kas saturēs datus bez izlēcējiem
file2 = 'valstspilsetas_bez/datu_apstrade/2024_fin.csv'
# Izejas fails, kas saturēs izlēcējus
file3 = 'valstspilsetas_bez/datu_apstrade/2024_izl.csv'
...
for pilseta in pilsetas:
    # Izveido jaunu datu kopu df_reg, kurā tiek iekļautas tikai tās rindas, kuras atbilst noteiktai pilsētai.
    df_pils = df[df['Pilsēta'] == pilseta]
    
    Q1 = df_pils['EUR/m^2'].quantile(0.25) # 1. kvartile
    Q3 = df_pils['EUR/m^2'].quantile(0.75) # 3. kvartile
    IQR = Q3 - Q1                          # Starpkvartilu attālums
    ...
    # Izņem no datiem tās rindas, kuru indeksi sakrīt ar indeksiem izlēcēju datu kopā
