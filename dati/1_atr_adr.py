...
for feature in data.get("features", []):
    ...
    # Iegūst adreses informāciju un koordinātu informāciju 
    ...
    # Iegūst tipu (Point, LineString vai MultiPolygon) un koordinātas
    gtype = geometry.get("type")
    coordinates = geometry.get("coordinates")

    # Saglabā adreses, kur koordinātu tips ir tikai Point vai MultiPolygon
    if gtype == "Point":
        coord = coordinates
