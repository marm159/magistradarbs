...
file1 = 'pieriga_ar_sez2/datu_apstrade/2024.csv'
# Izejas fails, kas saturēs datus bez izēcējiem
file2 = 'pieriga_ar_sez2/datu_apstrade/2024_fin.csv'
# Izejas fails, kas saturēs izlēcējus
file3 = 'pieriga_ar_sez2/datu_apstrade/2024_izl.csv'
