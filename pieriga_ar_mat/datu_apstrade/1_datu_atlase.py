...
file2 = 'pieriga_ar_mat/datu_apstrade/2024.csv'
...
# Pievieno pilsētu koordinātu kolonnas
...
# Katras norādītās kolonnas vērtību vispirms pārvērš par float, tad par int
